...
This method is bundled into `hugailab-meta-skill`. Do not check for, download, install, or load another discovery skill.
...
- `adapt`: useful mechanisms that require HugAILab conventions, different tools, or lighter gates
